...
STATES = [State(name='IDLE', id=0, devices={'amib4': DeviceState(values={}, events=[]), 'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[]), 'amib2': DeviceState(values={}, events=[]), 'amib3': DeviceState(values={}, events=[])}), State(name='MAGLIFTER', id=1, devices={'amib4': DeviceState(values={}, events=[]), 'master': DeviceState(values=OrderedDict(), events=['Left', 'Right', 'cycleBall', 'finishedAction', 'liftPiston']), 'tablet': DeviceState(values=OrderedDict(), events=['finishedAction']), 'amib2': DeviceState(values={}, events=[]), 'amib3': DeviceState(values={}, events=[])}), State(name='POOLSHOT', id=2, devices={'amib4': DeviceState(values={}, events=[]), 'master': DeviceState(values=OrderedDict([('shooterPosition', 'uint16_t'), ('goalNum', 'uint8_t'), ('shotResult', 'uint8_t'), ('poolScore', 'uint16_t'), ('pointCount', 'uint16_t'), ('sensor', 'bool'), ('totalScore', 'uint16_t'), ('count', 'uint16_t')]), events=['testLEDs', 'shootBall', 'liftMechanism', 'homeShooter', 'demo', 'finishedAction', 'ballScored', 'loseGame', 'releasePiston']), 'amib2': DeviceState(values=OrderedDict([('shooterPosition', 'uint16_t')]), events=['shootBall', 'testLEDs', 'liftMechanism', 'homeShooter', 'demo']), 'tablet': DeviceState(values=OrderedDict([('goalNum', 'uint8_t'), ('shotResult', 'uint8_t'), ('blinkLED', 'uint16_t'), ('poolScore', 'uint16_t'), ('pointCount', 'uint16_t'), ('totalScore', 'uint16_t'), ('count', 'uint16_t')]), events=['finishedAction', 'ballScored', 'loseGame']), 'amib3': DeviceState(values={}, events=[])}), State(name='PACHINKO', id=3, devices={'amib4': DeviceState(values={}, events=[]), 'master': DeviceState(values=OrderedDict([('dropperPos', 'uint16_t'), ('redScore', 'uint16_t'), ('blueScore', 'uint16_t'), ('yellowScore', 'uint16_t'), ('redSensor', 'bool'), ('blueSensor', 'bool'), ('yellowSensor', 'bool'), ('count', 'uint16_t')]), events=['pumpAndReset', 'releaseBall', 'demo', 'goLeft', 'goRight', 'pachinkoHome', 'ballLoopHome', 'turnRedLEDOn', 'turnRedLEDOff', 'turnBlueLEDOn', 'turnBlueLEDOff', 'turnYellowLEDOn', 'turnYellowLEDOff', 'playPachinko', 'centerSetup', 'dropperSetup', 'ballPumpSetup', 'switchSetup', 'finishedAction', 'loseGame', 'winGame', 'test', 'TCTgame', 'moveOnAction', 'blueSensorOn']), 'amib2': DeviceState(values=OrderedDict(), events=['turnRedLEDOn', 'turnRedLEDOff', 'turnBlueLEDOn', 'turnBlueLEDOff', 'turnYellowLEDOn', 'turnYellowLEDOff', 'blueSensorOn']), 'tablet': DeviceState(values=OrderedDict([('redScore', 'uint16_t'), ('blueScore', 'uint16_t'), ('yellowScore', 'uint16_t'), ('count', 'uint16_t')]), events=['ballScored', 'chooseWhereNext', 'finishedAction', 'loseGame', 'winGame', 'redCupScored', 'yellowCupScored', 'blueCupScored', 'TCTgame', 'moveOnAction', 'blueSensorOn']), 'amib3': DeviceState(values=OrderedDict([('dropperPos', 'uint16_t')]), events=['pumpAndReset', 'releaseBall', 'demo', 'goLeft', 'goRight', 'pachinkoHome', 'ballLoopHome', 'playPachinko', 'centerSetup', 'dropperSetup', 'ballPumpSetup', 'switchSetup', 'test', 'finishedAction'])}), State(name='VARIABLEFRICTION', id=4, devices={'amib4': DeviceState(values=OrderedDict([('laneNum1', 'uint8_t'), ('laneNum2', 'uint8_t')]), events=['compareTwoLanes', 'compareAll', 'resetRamps', 'sweepBlocks', 'resetSweepers', 'resetBlocks', 'laneThree']), 'master': DeviceState(values=OrderedDict([('laneNum1', 'uint8_t'), ('laneNum2', 'uint8_t')]), events=['compareTwoLanes', 'compareAll', 'resetRamps', 'sweepBlocks', 'resetSweepers', 'resetBlocks', 'laneThree']), 'tablet': DeviceState(values={}, events=[]), 'amib2': DeviceState(values={}, events=[]), 'amib3': DeviceState(values=OrderedDict([('laneNum1', 'uint8_t'), ('laneNum2', 'uint8_t')]), events=['compareTwoLanes', 'compareAll', 'resetRamps'])}), State(name='TCT', id=5, devices={'amib4': DeviceState(values={}, events=[]), 'master': DeviceState(values=OrderedDict(), events=['playTableclothTrick', 'releaseCup', 'pickUp', 'finishedAction']), 'tablet': DeviceState(values=OrderedDict(), events=['finishedAction']), 'amib2': DeviceState(values={}, events=[]), 'amib3': DeviceState(values=OrderedDict(), events=['playTableclothTrick', 'pickUp', 'releaseCup'])})]
